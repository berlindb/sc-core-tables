...
class Events extends Schema {
	...
	public $columns = array(
			...
			array( 'name' => 'start_tz', 'type' => 'varchar', 'length' => '20', 'default' => '' ),
			array( 'name' => 'end', 'type' => 'datetime', 'default' => '0000-00-00 00:00:00' ),
			array( 'name' => 'end_tz', 'type' => 'varchar', 'length' => '20', 'default' => '' ),
			array( 'name' => 'all_day', 'type' => 'tinyint', 'length' => '1', 'unsigned' => false, 'default' => '0' ),
			array( 'name' => 'recurrence', 'type' => 'varchar', 'length' => '20', 'default' => '' ),
			array( 'name' => 'recurrence_interval', 'type' => 'bigint', 'length' => '20', 'unsigned' => true, 'default' => '0' ),
			array( 'name' => 'recurrence_count', 'type' => 'bigint', 'length' => '20', 'unsigned' => true, 'default' => '0' ),
	...
	public $indexes = array(
			...
			array( 'type' => 'key', 'name' => 'event_times', 'columns' => array( 'start', 'end', 'start_tz', 'end_tz' ) ),
